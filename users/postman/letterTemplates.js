...
function getCompressedTokenLetter(name, email, token, tokenLink) {
    ...
    return `<section style="width:100%; background-color:hsla(213, 10%, 36%, 5%); padding: 50px 0; margin: 0">
        <div style="width: 100%; text-align: center; margin: 0; padding: 0">
            <h1 style="margin: 10px 0 0 0; padding: 0; font-size: 42px; font-weight: 800; text-transform: uppercase; letter-spacing: -0.6px; color: hsl(213, 10%, 36%)">BoltCDL Software</h1>
            <div style="max-width: 600px; margin: 0 auto;  padding: 35px; background-color: white; border: 1px solid hsla(213, 10%, 36%, 20%); border-radius: 5px; text-align: justify">
                ...
                <p style="margin-bottom: 0.8em; font-size: 12.5px; font-weight: 700; color: hsla(0, 0%, 18%, 90%)">You probably will be warned that you are trying to send information to an external page, so just confirm and your data will be passed in a most secure way.</p>
    ...
    return `<section style="width:100%; background-color:#535b650d; padding: 50px 0; margin: 0">
        <div style="width: 100%; text-align: center; margin: 0; padding: 0">
            <div style="max-width: 600px; margin: 0 auto;  padding: 35px; background-color: white; border: 1px solid #535b6533; border-radius: 5px; text-align: justify">
                ...
                <p style="margin-bottom: 0.8em; font-size: 18px; font-weight: 500; color: #2e2e2ecc">A request has been received to ${actionType} the password for your BoltCDL account.</p>
                <p style="margin-bottom: 0.8em; font-size: 15px; font-weight: 700; color: #2e2e2ee6; line-height: 24px; text-align: justify;text-align-last: center;">Your new password is <span style="font-size: 22px; font-weight: 500;background-color:#535b6526;color: #e47337; padding: 5px 10px; border-radius: 17px;">${password}</span>. This password is for permanent use, however you can change it at your profile, if you’d like to.</p>
                ...
                <p style="margin-bottom: 0.8em; font-size: 22px; font-weight: 400; color: #2e2e2e99">Thank you,<br>The BoltCDL Team</p>
            </div>
